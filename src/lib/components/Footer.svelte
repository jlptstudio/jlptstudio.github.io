...
<style>
	...
	.cta-box {
		text-align: center;
		padding: 4rem 2rem;
		background: linear-gradient(135deg, var(--lavender-100), var(--lavender-50), var(--peach-50));
